...
class ConeCME:
    ...
    def compute_arrival_at_body(self, body_name):
        ...
        arrival_stats = {'hit':hit, 't_arrive': t_arrive, 't_transit':t_transit,
                        'hit_lon':hit_lon, 'hit_rad':hit_rad, 'hit_id':hit_id}
...
def huxt_constants():
    ...
    """
    nlong = 512  # Number of longitude bins for a full longitude grid [128]
    dr = 1 * u.solRad  # Radial grid step. With v_max, this sets the model time step [1.5*u.solRad]
